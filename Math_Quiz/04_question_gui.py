...
class Start:
    ...
    def check_difficulty(self, difficulty):
        ...
        Quiz(self, difficulty, num1, op, num2)
...
class Quiz:
    def __init__(self, partner, difficulty, num1, op, num2):
        print(difficulty, num1, op, num2)
        ...
        self.question_box = Label(self.quiz_frame, text=question, font="arial 16", justify=CENTER, bg="grey")
